...
export default abstract class Bundler<C = {}> extends Component<BundlerSpace.Config & C> {
  ...
  public mode: BundlerSpace.Modes;
  ...
  public developmentPortClient?: number;

  public developmentPortServer?: number;
  ...
  public get defaults(): any {
    return {
      mode: 'development' as BundlerSpace.Modes,
      base: '/',
    };
  }
