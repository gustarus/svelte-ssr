...
function resolveCommandPorts(cmd) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const nodePort = yield resolveAvailablePort_1.default(cmd.nodePort || constants_1.DEFAULT_LISTEN_PORT);
        const clientPort = yield resolveAvailablePort_1.default(cmd.clientPort || constants_1.DEFAULT_CLIENT_PORT);
        const serverPort = yield resolveAvailablePort_1.default(cmd.serverPort || constants_1.DEFAULT_SERVER_PORT);
        return {
